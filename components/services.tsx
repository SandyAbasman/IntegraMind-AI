...
const services = [
  {
    ...
    description:
      "Deploy intelligent chatbots that handle customer inquiries, lead qualification, and support tickets 24/7.",
    features: [
  ...
  //   description:
  //     "Streamline internal and external communications with automated emails, notifications, and follow-ups.",
  ...
  //   description:
  //     "Generate automated reports and dashboards that provide real-time insights into your business performance.",
  ...
  //   description:
  //     "Tailored AI solutions designed specifically for your unique business requirements and challenges.",
        ...
        {services.map((service) => {
          ...
          return (
            <Card key={service.title}>
              <CardHeader>
                <div className="h-12 w-12 rounded-lg bg-[#0F0F0F] flex items-center justify-center mb-4">
                  <Icon className="h-6 w-6 text-[#E7BEB1]" />
                </div>
              ...
              <CardContent>
                <ul className="space-y-2">
                  {service.features.map((feature) => (
                    <li
                      key={feature}
                      className="text-sm text-[#B3B3B2] flex items-center"
                    >
